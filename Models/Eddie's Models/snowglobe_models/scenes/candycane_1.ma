...
//Name: candycane_1.ma
//Last modified: Tue, Nov 19, 2019 06:07:03 PM
//Codeset: 1252
requires maya "2019";
requires "mtoa" "3.1.2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.9212469366938798 5.8827209926629092 -3.3783573240650226 ;
	setAttr ".r" -type "double3" -33.33835272960404 115.00000000000064 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 10.400034627223645;
	setAttr ".ow" 0.1;
...
createNode camera -s -n "frontShape" -p "front";
	...
	setAttr ".fd" 0.05;
	setAttr ".coi" 10.001000000000001;
	setAttr ".ow" 0.32843818879492764;
